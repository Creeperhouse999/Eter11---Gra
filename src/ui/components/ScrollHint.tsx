...
export function ScrollHint() {
  ...
  return (
    <button
      ...
      className="eter-fade-in fixed bottom-3 left-1/2 flex min-h-11 -translate-x-1/2 items-center gap-1.5 rounded-full border border-accent bg-surface px-3 py-1.5 text-xs shadow-lg"
