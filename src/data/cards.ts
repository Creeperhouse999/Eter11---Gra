...
const psychological: Card[] = [
  ...
  { id: 'psy-r-wytrwalosc', name: 'Nieustępliwość', category: 'psychological', family: 'red', icon: 'mountain', description: 'Wraca do sprawy, choć raz już się nie udało.', draft: true },
